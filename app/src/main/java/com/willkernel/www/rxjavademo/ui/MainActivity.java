...
public class MainActivity extends AppCompatActivity {
  ...
  public RetrofitHelper retrofitHelper = new RetrofitHelper();
  ...
  public void test30(View v) {
    Flowable.create(new FlowableOnSubscribe<Integer>() {
      ...
      public void subscribe(FlowableEmitter<Integer> e) throws Exception {
        ...
        e.onComplete();
        Log.e(TAG, "onComplete request=" + e.requested());
...
//                }
  ...
  public void emitter(ObservableEmitter<Integer> e) {
    e.onNext(1);
    Log.e(TAG, "1");
    e.onNext(2);
    Log.e(TAG, "2");
